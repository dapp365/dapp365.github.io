window.skins={};
	...
	function btnSceneSkin() {
		_super.call(this);
		this.skinParts = ["_btn_help","_btn_more","_UIGShowCpu","_UIGShowMoney","_gp_login","_btn_login","_btn_login_en","_btn_lang_zh","_btn_lang_en","_wind"];
	...
	_proto._wind_i = function () {
		...
		t.top = 0;
		t.touchEnabled = false;
		t.elementsContent = [this._btn_help_i(),this._btn_more_i(),this._gp_login_i(),this._btn_login_i(),this._btn_login_en_i(),this._btn_lang_zh_i(),this._btn_lang_en_i()];
		return t;
	};
	...
	function gameSkin() {
		_super.call(this);
		this.skinParts = ["_bg","_scr_gp","_scr","_UIGTimeCount","_UIBtnScene","_UIGWinList","_scr_gp_info","_scr_info","_mask","_wind"];
	...
	_proto._wind_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this._bg_i(),this._scr_info_i(),this._mask_i()];
		return t;
	};
	_proto._bg_i = function () {
		var t = new eui.Image();
	...
	_proto._Group1_i = function () {
		...
		t.x = 0;
		t.y = 30;
		t.elementsContent = [this._scr_i(),this._UIGTimeCount_i(),this._UIBtnScene_i(),this._UIGWinList_i()];
		return t;
	};
	_proto._scr_i = function () {
		var t = new eui.Scroller();
	...
	_proto._Image1_i = function () {
		var t = new eui.Image();
		t.scale9Grid = new egret.Rectangle(15,19,93,117);
		t.source = "Rplist0_json.img_plist0_regional4";
		t.x = 1755.11;
		t.y = 161.89;
		return t;
	};
	...
	var gFirstLoginSkin$Skin12 = 	(function (_super) {
		__extends(gFirstLoginSkin$Skin12, _super);
		function gFirstLoginSkin$Skin12() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = gFirstLoginSkin$Skin12.prototype;
	...
	_proto._btn_close_i = function () {
		...
		t.x = 1580;
		t.y = 21;
		t.skinName = gFirstLoginSkin$Skin12;
		return t;
	};
	...
	var gIntroduceSkin$Skin15 = 	(function (_super) {
		__extends(gIntroduceSkin$Skin15, _super);
		function gIntroduceSkin$Skin15() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = gIntroduceSkin$Skin15.prototype;
	...
	_proto._btn_close_i = function () {
		...
		t.x = 1580;
		t.y = 21;
		t.skinName = gIntroduceSkin$Skin15;
		return t;
	};
	_proto._title_i = function () {
		var t = new eui.Image();
	...
	var gMoreSkin$Skin16 = 	(function (_super) {
		__extends(gMoreSkin$Skin16, _super);
		function gMoreSkin$Skin16() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = gMoreSkin$Skin16.prototype;
	...
	function gMoreSkin() {
		...
		this.states = [
			new eui.State ("nologin",
				[
					new eui.AddItems("_btn_lang","_Group1",1,""),
			...
			new eui.State ("login",
				[
					...
					new eui.SetProperty("_Label2","top",484),
					new eui.SetProperty("_Label2","x",425),
					new eui.SetProperty("_font_gameRule","x",50),
	...
	_proto._Group1_i = function () {
		...
		t.x = 1180;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this._btn_close_i(),this._font_tjyj_i(),this._btn_tjyj_i(),this._font_sound_i(),this._btn_sound_i(),this._Label1_i(),this._btn_dapp365_i(),this._font_cutLang_i(),this._Label2_i(),this._font_gameRule_i(),this._btn_game_i(),this._btn_share1_i(),this._btn_share2_i(),this._btn_share0_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	var gRecordSkin$Skin17 = 	(function (_super) {
		__extends(gRecordSkin$Skin17, _super);
		function gRecordSkin$Skin17() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = gRecordSkin$Skin17.prototype;
