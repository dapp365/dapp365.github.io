window.skins={};
	...
	function gameSkin() {
		...
		this.height = 1125;
		this.width = 2000;
		this.elementsContent = [this._Rect1_i(),this._wind_i()];
	}
	...
	_proto._gp_pulldown_i = function () {
		...
		t.x = 442;
		t.y = 927;
		t.elementsContent = [this._drop_down_i(),this._Rect1_i(),this._font_pull_i()];
		return t;
	};
	...
	function gFirstLoginSkin() {
		_super.call(this);
		this.skinParts = ["_rect","_btn_close","_btn_IKnow","_btn_IKnow_en","_title","_font0","_suer_bet0","_font1","_back","_font2","_suer_bet","_font3","_allback","_font4","_wind"];
	...
	_proto._font0_i = function () {
		...
		t.lineSpacing = 30;
		t.size = 36;
		t.text = "After placing chips on the betting area, click                            before end of the round to confirm the bet.";
		t.textColor = 0xd3b992;
		t.width = 1200;
		t.y = 3;
		return t;
	...
	_proto._font1_i = function () {
		...
		t.lineSpacing = 30;
		t.size = 36;
		t.text = "After selecting an area, click                            to cancel all unconfirmed chips in that area.";
		t.textColor = 0xD3B992;
		t.width = 1200;
		t.y = 1;
		return t;
	...
	_proto._font2_i = function () {
		...
		t.lineSpacing = 30;
		t.size = 36;
		t.text = "Click                           in any area will confirm all chips placed in current round, regardless of the betting area.";
		t.textColor = 0xD3B992;
		t.width = 1200;
		t.x = 27;
		t.y = 1;
	...
	_proto._Group4_i = function () {
		...
		t.x = 2;
		t.y = 414;
		t.elementsContent = [this._font3_i(),this._Label4_i(),this._allback_i()];
		return t;
	};
	_proto._font3_i = function () {
		...
		t.lineSpacing = 30;
		t.size = 36;
		t.text = "Click        on top left corner to cancel all unconfirmed chips in current round.";
		t.textColor = 0xD3B992;
		t.width = 1200;
		t.x = 27;
		t.y = 1;
	...
	_proto._font4_i = function () {
		...
		t.lineSpacing = 30;
		t.size = 36;
		t.text = "Please see game rules for more details.";
		t.textColor = 0xD3B992;
		t.width = 1200;
		t.x = 27;
		t.y = 1;
	...
	_proto._font1_i = function () {
		...
		t.scaleY = 1;
		t.size = 36;
		t.text = "•  This game is played with a roulette and a betting Table\n•  There are number 1-36 colored either red or black, and a green number 0 on the roulette.\n•  Players will have 40 seconds to place bets in each round. After betting phase, the roulette will start to rotate clockwise and a ball will start to travel counter-clockwise. The ball will fall into one of the number slots. And if the winning number matches your bet, you will win prize based on the odds of the bet type.\n•  No limit for player quantity. Bets range from 0.1EOS to 50EOS in one round.";
		t.textAlign = "left";
		t.textColor = 0xD3B992;
		t.width = 1200;
		t.x = 18;
	...
	function gMoreSkin() {
		_super.call(this);
		this.skinParts = ["_rect","_btn_close","_name","_btn_byebye","_font_tjyj","_btn_tjyj","_font_sound","_btn_sound","_btn_dapp365","_font_cutLang","_font_lang","_font_gameRule","_btn_game","_btn_share1","_btn_share0","_btn_lang","_wind"];
		...
		this.states = [
			new eui.State ("nologin",
				[
					...
					new eui.SetProperty("_font_lang","y",471),
					new eui.SetProperty("_font_lang","right",234),
			...
			new eui.State ("login",
				[
					...
					new eui.SetProperty("_font_lang","y",484),
					new eui.SetProperty("_font_lang","right",235),
					new eui.SetProperty("_font_gameRule","x",50),
					...
					new eui.SetProperty("_Image2","x",506),
					new eui.SetProperty("_Image2","y",496),
					new eui.SetProperty("_btn_lang","y",464)
				])
		];
	}
	...
	_proto._Group1_i = function () {
		...
		t.x = 1085;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this._btn_close_i(),this._font_tjyj_i(),this._btn_tjyj_i(),this._font_sound_i(),this._btn_sound_i(),this._Label1_i(),this._btn_dapp365_i(),this._font_cutLang_i(),this._font_lang_i(),this._font_gameRule_i(),this._btn_game_i(),this._btn_share1_i(),this._btn_share0_i(),this._Image2_i(),this._btn_lang_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
...
})(eui.Skin);generateEUI.paths['resource/skin/gTuiJianYouJiangSkin.exml'] = window.gTuiJianYouJiangSkin = (function (_super) {
	__extends(gTuiJianYouJiangSkin, _super);
	var gTuiJianYouJiangSkin$Skin24 = 	(function (_super) {
		__extends(gTuiJianYouJiangSkin$Skin24, _super);
		function gTuiJianYouJiangSkin$Skin24() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = gTuiJianYouJiangSkin$Skin24.prototype;
		...
		return gTuiJianYouJiangSkin$Skin24;
	})(eui.Skin);

	var gTuiJianYouJiangSkin$Skin25 = 	(function (_super) {
		__extends(gTuiJianYouJiangSkin$Skin25, _super);
		function gTuiJianYouJiangSkin$Skin25() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = gTuiJianYouJiangSkin$Skin25.prototype;
		...
		return gTuiJianYouJiangSkin$Skin25;
	})(eui.Skin);

	var gTuiJianYouJiangSkin$Skin26 = 	(function (_super) {
		__extends(gTuiJianYouJiangSkin$Skin26, _super);
		function gTuiJianYouJiangSkin$Skin26() {
			_super.call(this);
			this.skinParts = ["labelDisplay"];
		...
		var _proto = gTuiJianYouJiangSkin$Skin26.prototype;
		...
		return gTuiJianYouJiangSkin$Skin26;
	})(eui.Skin);

	function gTuiJianYouJiangSkin() {
		_super.call(this);
		this.skinParts = ["_rect","_btn_close","_btn_IKnow","_btn_IKnow_en","_title","_font0","_font1","_font2","_font_url","_font_copy","_gp_url","_wind"];
		
		this.height = 1125;
		this.width = 2000;
		this.elementsContent = [this._wind_i()];
	}
	var _proto = gTuiJianYouJiangSkin.prototype;
	...
	_proto._Group2_i = function () {
		...
		t.x = -94;
		t.y = 0;
		t.elementsContent = [this._Image1_i(),this._btn_close_i(),this._btn_IKnow_i(),this._btn_IKnow_en_i(),this._title_i(),this._Group1_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
	...
	_proto._btn_close_i = function () {
		...
		t.x = 1580;
		t.y = 21;
		t.skinName = gTuiJianYouJiangSkin$Skin24;
		return t;
	};
	_proto._btn_IKnow_i = function () {
		var t = new eui.Button();
		...
		t.x = 766;
		t.y = 863.36;
		t.skinName = gTuiJianYouJiangSkin$Skin25;
		return t;
	};
	_proto._btn_IKnow_en_i = function () {
		var t = new eui.Button();
		...
		t.x = 766;
		t.y = 863.36;
		t.skinName = gTuiJianYouJiangSkin$Skin26;
		return t;
	};
	_proto._title_i = function () {
		var t = new eui.Image();
		this._title = t;
		t.source = "Rplist1_json.img_plist1_yqyj";
		t.x = 858;
		t.y = 69;
		return t;
	};
	_proto._Group1_i = function () {
		...
		t.x = 416;
		t.y = 247;
		t.elementsContent = [this._font0_i(),this._font1_i(),this._font2_i(),this._gp_url_i()];
		return t;
	};
	_proto._font0_i = function () {
		var t = new eui.Label();
	...
	_proto._font2_i = function () {
		...
		t.scaleY = 1;
		t.size = 48;
		t.text = "•  Share a link to invite friends.if the new user from your link to enter the site and complete the first bet, the recommendation is successful.\n•  Each time the recommend makes a bet, the recommended will get 5% of the bet amount as commission.";
		t.textColor = 0xd3b992;
		t.width = 1251;
		t.x = 39;
		t.y = 277.64;
	...
	_proto._gp_url_i = function () {
		...
		t.x = 0;
		t.y = 77;
		t.elementsContent = [this._Rect1_i(),this._font_url_i(),this._Rect2_i(),this._font_copy_i()];
		return t;
	};
	_proto._Rect1_i = function () {
		var t = new eui.Rect();
		t.fillColor = 0x39270e;
		t.height = 90;
		t.width = 1109;
		t.x = 0;
		t.y = 0;
	...
	_proto._font_copy_i = function () {
		var t = new eui.Label();
		this._font_copy = t;
		t.horizontalCenter = 561;
		t.size = 36;
		t.text = "复制";
		t.y = 24.03;
		return t;
	};
	return gTuiJianYouJiangSkin;
